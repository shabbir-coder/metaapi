...
router.get('/list/:eventId', instanceController.listAll);

router.get('/list', instanceController.listAll);

router.get('/fetch/:instance_id', instanceController.getByNumber);
